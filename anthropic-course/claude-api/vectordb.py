...
class VectorIndex:
    ...
    def search(
        ...
        if isinstance(query, str):results = sotre.search("What is the purpose of the report?", 2)
            if not self._embedding_fn:
                raise ValueError(
...
for doc, dist in results:
    print(f"Distance: {dist:.4f}, Content: {doc['content'][:100]}...")  # Print first 100 chars of content